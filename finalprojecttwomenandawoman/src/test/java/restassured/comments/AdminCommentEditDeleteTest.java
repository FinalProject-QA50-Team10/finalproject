...
import static com.telerikacademy.testframework.api.utils.Constants.COMMENT_DESCRIPTION_VALID;
...
public class AdminCommentEditDeleteTest {
    ...
    public void when_adminEditsComment_expect_commentIsEdited() {
        Response editCommentResponse = posts.editComment(ADMIN_NAME, ADMIN_PASSWORD, EDIT_COMMENT_CONTENT, lastCommentId);
    ...
    public void when_adminDeletesComment_expect_commentIsDeleted() {
        Response deleteCommentResponse = posts.deleteComment(ADMIN_NAME, ADMIN_PASSWORD, lastCommentId);
